...
//  gridtokexios
//
//  06b · Dashboard "Easy view" — age-friendly / accessible landing after login.
//  Larger type, bigger tap targets, plain language, high contrast.
//  Native port of mock-ui/dashboard-easy.jsx.
//
